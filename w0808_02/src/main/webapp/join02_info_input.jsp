...
<html>
	...
	<body>
		...
		<section>
			<form name="agree" method="get" action="./doForm2.jsp">
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_pw2_dl">
						...
						<dd>
							<input type="password" onkeyup="pwCheck()" id="pw2" name="pw2" minlength="8" required />
							<span id="pwTxt">비밀번호를 다시 한번 입력해 주세요.</span>
						</dd>
					</dl>
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_interests_dl">
						...
						<dd>
							<ul>
								<li>
									<input type="checkbox" name="favorite" id="computer" value="computer" />
									<label for="computer">컴퓨터/인터넷</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="movie" value="movie" />
									<label for="movie">영화/비디오</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="music" value="music" />
									<label for="music">음악</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="shopping" value="shopping" />
									<label for="shopping">쇼핑</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="game" value="game" />
									<label for="game">게임</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="culture" value="culture" />
									<label for="culture">문화/예술</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="parenting" value="parenting" />
									<label for="parenting">육아/아동</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="cooking" value="cooking" />
									<label for="parenting">요리</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="interier" value="interier" />
									<label for="interier">인테리어</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="leisure" value="leisure" />
									<label for="leisure">레저/여가</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="health" value="health" />
									<label for="health">건강/다이어트</label>
								</li>
								<li>
									<input type="checkbox" name="favorite" id="fashion" value="fashion" />
